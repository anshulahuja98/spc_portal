...
from .views import DetailsView, ResumeView, InternshipOffersView, JobOffersView, InquirysFormView, SuggestionsFormView
...
urlpatterns = [
    ...
    path('inquiry/', InquirysFormView.as_view(), name='inquiry'),
