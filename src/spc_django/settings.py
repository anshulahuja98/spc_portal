...
SEND_EMAIL_STUDENT = config('SEND_EMAIL_STUDENT', default=True, cast=bool)
SEND_EMAIL_COMPANY = config('SEND_EMAIL_COMPANY', default=True, cast=bool)
...
COMPLAINT_RECIPIENT_EMAIL = config('COMPLAINT_RECIPIENT_EMAIL')
